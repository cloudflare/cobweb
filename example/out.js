...
function js_append_http_body(body){ const get_string = Module.cwrap('get_string', 'string', ['number']); globalThis.response.body += get_string(body); }
function js_get_http_form(name){ const get_string = Module.cwrap('get_string', 'string', ['number']); const v = globalThis.request.params[get_string(name)]; if (v === undefined) { return 0; } else { return v; } }
function js_set_http_body(body){ const get_string = Module.cwrap('get_string', 'string', ['number']); globalThis.response.body = get_string(body); }
function js_set_http_status(code){ const get_string = Module.cwrap('get_string', 'string', ['number']); globalThis.response.status = parseInt(get_string(code)); }
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=25600;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 25648, 4), 25648);
  ...
  err('dead function: main'); abort(-1);
  }
...
var asmGlobalArg = {};
var asmLibraryArg = { "__handle_stack_overflow": ___handle_stack_overflow, "__map_file": ___map_file, "__sys_access": ___sys_access, "__sys_fcntl64": ___sys_fcntl64, "__sys_fdatasync": ___sys_fdatasync, "__sys_fstat64": ___sys_fstat64, "__sys_ioctl": ___sys_ioctl, "__sys_munmap": ___sys_munmap, "__sys_open": ___sys_open, "__sys_read": ___sys_read, "__sys_readlink": ___sys_readlink, "__sys_stat64": ___sys_stat64, "abort": _abort, "clock_gettime": _clock_gettime, "dlclose": _dlclose, "dlopen": _dlopen, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_fdstat_get": _fd_fdstat_get, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "js_append_http_body": js_append_http_body, "js_get_http_form": js_get_http_form, "js_set_http_body": js_set_http_body, "js_set_http_status": js_set_http_status, "localtime": _localtime, "memory": wasmMemory, "mktime": _mktime, "raise": _raise, "setTempRet0": _setTempRet0, "sigaction": _sigaction, "sigemptyset": _sigemptyset, "strftime": _strftime, "table": wasmTable, "time": _time };
var asm = createWasm();
Module["asm"] = asm;
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var ___em_js__js_set_http_status = Module["___em_js__js_set_http_status"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__js_set_http_status"].apply(null, arguments)
};

/** @type {function(...*):?} */
var ___em_js__js_append_http_body = Module["___em_js__js_append_http_body"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__js_append_http_body"].apply(null, arguments)
};

/** @type {function(...*):?} */
var ___em_js__js_set_http_body = Module["___em_js__js_set_http_body"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__js_set_http_body"].apply(null, arguments)
};

/** @type {function(...*):?} */
var ___em_js__js_get_http_form = Module["___em_js__js_get_http_form"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__js_get_http_form"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _get_string = Module["_get_string"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["get_string"].apply(null, arguments)
};
...
var _entry = Module["_entry"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["entry"].apply(null, arguments)
};
